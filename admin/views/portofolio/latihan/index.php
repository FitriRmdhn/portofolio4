...
<div class="jumbotron text-center mt-0" style="background-color: #B0E0E6;">
    <img src="../img/fitri.jpg" alt="Fitri Ramadhani" width="200px" class="rounded-circle">
  <h1 class="display-4">Fitri Ramadhani</h1>
    ...
    <section id="about">
        <div class="container">
            ...
            <div class="row justify-content-center fs-6 text-center">
                <div class="col-sm">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores, iste numquam harum debitis recusandae quidem dolore accusamus reprehenderit voluptas dignissimos iure amet accusantium, voluptates inventore!</p>
                </div>
                <div class="col-sm">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam, amet dolore dolor, iure quod facere sapiente rerum unde odit cum, magni voluptatem ut vel totam?</p>
                </div>
            </div>
        </div>
